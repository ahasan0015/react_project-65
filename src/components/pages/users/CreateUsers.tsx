  ...
  return (
    <>
      <div className="container-xxl flex-grow-1 container-p-y">
        <h4 className="fw-bold py-3 mb-4"><Link to="/manage-users" className="text-muted fw-light">Users /</Link> Create</h4>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={(e) => {
                    if (e.target.files !== null) setUser({ ...user, photo: e.target.files[0] });
                  }}
                />
              </div>
